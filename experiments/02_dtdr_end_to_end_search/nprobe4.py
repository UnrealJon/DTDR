"""
Experiment 02 — DTDR-native IVF + HNSW + binary reranking

This script evaluates end-to-end ANN search entirely in the
Distributed Transform-Domain Representation (DTDR), with optional
multi-resolution dilution evidence for coarse localisation.
"""
...
def main():
    ...
    for qi in range(args.q):
        ...
        per_list_budget = min(
    max(10, args.cand // max(1, len(probe_lists))),
    args.ef
)
