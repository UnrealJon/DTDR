...
functionality while reducing memory footprint and bandwidth pressure. It has been designed to be a file format for the persistent storage of such data that in many cases has advantages over conventional floating point representations.
