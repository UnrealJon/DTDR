...
This repository provides a reference implementation and accompanying technical documentation for DTDR, a persistent transform-domain representation for semantically encoded high-dimensional numerical data intended for stored-at-rest use.
...
\- \[DTDR Overview (PDF)](https://github.com/UnrealJon/DTDR/blob/main/docs/DTDR_Overview.pdf)
...
DTDR is the subject of a filed UK patent application (UK Patent Application No. 2602157.6). The material in this repository is provided to support technical evaluation and discussion.
